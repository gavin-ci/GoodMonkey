...
Ayaka = baseFile("kamisato Ayaka", "Frostflake Heron","Cryo", "Sword", "Mistsplitter Reforged", 1001, 27, 61, "Crit DMG", "Kamisato Art: Hyouka", 64, "Kamisato Art: Soumetsu", 75)
...
print("name = ", Ayaka.name, "\ntitle = ", Ayaka.title, "\nvision = ",Ayaka.vision,"\nweapon type = ",Ayaka.weaponType,"\nsignature weapon = ",Ayaka.signatureWeapon, "\nbaseHp = ", Ayaka.baseHp, "\nbaseAtk = ", Ayaka.baseAtk, "\nbaseDef = ", Ayaka.baseDef, "\nspecial stat = ", Ayaka.special, "\nskill = ", Ayaka.skill, "\nskill DMG = ", Ayaka.skillDmg, "\nburst = ", Ayaka.burst, "\nburst DMG = ", Ayaka.burstDmg, "\n")